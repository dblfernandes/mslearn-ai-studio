...
def main(): 
    ...
    try:
        ...
        #percorrendo todos os arquivos PDF na pasta "brochures" e abrindo-os em modo binário
        file_streams = [open(f, "rb") for f in glob.glob("brochures/*.pdf")]
        if not file_streams:
            print("No PDF files found in the brochures folder!")
            return
        # uploading files to the vector store and polling for completion
        ...
        while True:
            ...
            response = openai_client.responses.create(
                ...
                #usa a ferramenta de busca de arquivos e a ferramenta de busca na web para fornecer respostas mais precisas, a busca na web só é usada quando a busca de arquivos não retorna resultados relevantes
                tools=[
                    {
                        "type": "file_search",
